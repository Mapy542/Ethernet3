...
class W5500Class {
   public:
    ...
    void send_data_processing_offset(SOCKET s, uint16_t data_offset, const uint8_t *data,
                                     uint16_t len);
...
void W5500Class::setRetransmissionTime(uint16_t _timeout) { writeRTR(_timeout); }
...
void W5500Class::swReset() { writeMR((readMR() | 0x80)); }
