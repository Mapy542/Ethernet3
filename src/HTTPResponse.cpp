...
HTTPResponse::HTTPResponse()
    : _protocol("HTTP/1.1"), _statusCode(200), _statusMessage("OK"), _headerCount(0) {}
...
void HTTPResponse::setStatusMessage(const String& statusMessage) { _statusMessage = statusMessage; }

void HTTPResponse::setProtocol(const String& protocol) { _protocol = protocol; }
...
String HTTPResponse::getStatusMessage() const { return _statusMessage; }

String HTTPResponse::getProtocol() const { return _protocol; }

String HTTPResponse::getBody() const { return _body; }

uint8_t HTTPResponse::getHeaderCount() const { return _headerCount; }
